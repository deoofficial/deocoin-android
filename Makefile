...
ios-prod:
	...
	open cordova/project/platforms/ios/Deocoin\ Mobile\ Wallet.xcodeproj
...
android-prod:
	...
	jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore deocoin.keystore -signedjar cordova/project/platforms/android/build/outputs/apk/android-release-signed.apk  cordova/project/platforms/android/build/outputs/apk/android-release-unsigned.apk deocoin 
